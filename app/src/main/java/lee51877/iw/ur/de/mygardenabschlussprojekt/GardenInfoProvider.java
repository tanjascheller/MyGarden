 ...
 */
public class GardenInfoProvider {

    public GardenInfoProvider (){
    ...
    private class DownLoadGardenInfoTask extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... params) {
           ...
           OAuthService service = new ServiceBuilder()
                    .provider(MyGardenAPI.class)
                    .apiKey(MyGardenConstants.CONSUMER_KEY)
                    .apiSecret(MyGardenConstants.CONSUMER_SECRET)
            ...
            OAuthRequest request = new OAuthRequest(Verb.GET, MyGardenConstants.RESSOURCE_POPULAR_PLANTS);
            service.signRequest(accessToken, request); // the access token from step 4
            Response response = request.send();
            Log.d("Result " + response.getBody());

            OAuthRequest request2 = new OAuthRequest(Verb.GET, MyGardenConstants.RESSOURCE_SEARCH_PLANT + "pear");
            ...
            OAuthRequest request3 = new OAuthRequest(Verb.GET, MyGardenConstants.RESSOURCE_PLANT_FOTOS + "4");
            ...
            OAuthRequest postreq = new OAuthRequest(Verb.GET, MyGardenConstants.RESSOURCE_PLANT_ACTIONS + "4");
